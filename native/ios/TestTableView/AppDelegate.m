...
{
  [context evaluateScript:[NSString stringWithFormat:@"goog.require('%@');", [self munge:@"test-table-view.core"]]];
}
...
- (void)contentDidAppear
{
  ...
  JSValue* initFn = [self getValue:@"init" inNamespace:@"test-table-view.core" fromContext:context];
